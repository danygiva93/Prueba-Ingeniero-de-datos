...
-- Paso 3: Seleccionar las rachas consecutivas
SELECT *
FROM (
    SELECT 
        identificacion,
    ...
    HAVING COUNT(*) >= 5  -- Filtrar las rachas con al menos 3 meses consecutivos
    ORDER BY identificacion, nivel
) AS rachas_filtradas;  -- Alias para la subconsulta
